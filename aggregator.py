...
for state in precincts_in:
    precincts_in[state]["rVote"] = estimated_votes_approval
    precincts_in[state]["dVote"] = opposite_total
    precincts_in[state]["rVote"] += precincts_in[state]["pvi"] / 2
    precincts_in[state]["dVote"] -= precincts_in[state]["pvi"] / 2
